...
```
vendor/bin/phpunit tests/unit/Espo/Modules/ManualScheduledJob
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/ManualScheduledJob
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/ManualScheduledJob`
* `site/tests/integration/Espo/Modules/ManualScheduledJob`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/ManualScheduledJob/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/ManualScheduledJob/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/manual-scheduled-job/lib/init.js"
        ]
    }
    ```
